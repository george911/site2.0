class ReviewsController < ApplicationController
  ...
  def create
    @review = @user.reviews.build(author_id:current_user.id,author:current_user.user_name,body:params[:review][:body],rating:params[:review][:rating],top:params[:review][:top])
  ...
  private
    ...
    def review_params
      params.require(:review).permit(:employer,:author, :author_id, :top, :body, :rating, :user_id)
    end
end
